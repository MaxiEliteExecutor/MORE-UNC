...
-- Place this in a Server Script (e.g., ServerScriptService)
local HttpService = game:GetService("HttpService")
local url = "https://raw.githubusercontent.com/unified-naming-convention/NamingStandard/main/UNCCheckEnv.lua"

local success, response = pcall(function()
    return HttpService:GetAsync(url, true) -- 'true' enables caching, like game:HttpGet
end)
